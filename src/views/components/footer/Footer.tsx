    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-2">
          ...
          <p className="mb-6">
            Nurturing young minds from ages 3 to 16 with quality care and education in a safe, stimulating environment.
          </p>
      ...
      <div className="border-t border-gray-800 py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Little Steps Learning Center. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link to="/privacy" className="text-sm hover:text-white transition">Privacy Policy</Link>
            <Link to="/terms" className="text-sm hover:text-white transition">Terms</Link>
            <Link to="/safety" className="text-sm hover:text-white transition">Safety Protocols</Link>
          </div>
        </div>
      </div>
    </footer>
